...
class Config(object):
    ...
    OWNER_ID = getenv("OWNER_ID", "7753899951") 
    OWNER_USERNAME = getenv("OWNER_USERNAME", "OWNER_OF_PR")
    SUPPORT_CHAT = getenv("SUPPORT_CHAT", "PR_ALL_BOT_SUPPORT")
    START_IMG = getenv("START_IMG", "https://graph.org/file/eaa3a2602e43844a488a5.jpg")
    JOIN_LOGGER = getenv("JOIN_LOGGER", "-1003506936897")
    EVENT_LOGS = getenv("EVENT_LOGS",  "-1003506936897")
    ERROR_LOGS = getenv("ERROR_LOGS", "-1003506936897")
    MONGO_DB_URI = getenv("MONGO_DB_URI", None)
    LOG_CHANNEL = getenv("LOG_CHANNEL", "-1003506936897")
